...
data=/data/OFA/caption_data/caption_test.tsv
...
restore_file=/data/OFA/logs/large_s2_mofa_checkpoints/8e-6_3/checkpoint_3_5000.pt  # 3_5000: 141.7
...
python coco_eval.py ../../results/caption/test_predict.json /data/OFA/caption_data/test_caption_coco_format.json
