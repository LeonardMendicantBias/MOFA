...
log_dir=/data/OFA/logs/s2_mofa_base_logs
save_dir=/data/OFA/logs/s2_mofa_base_checkpoints
...
restore_file=/data/OFA/logs/s1_ofa_base_checkpoints/2_0.06_2500/checkpoint_best.pt
# restore_file=/data/OFA/logs/s1_mofa_base_checkpoints/2_0.06_2500/checkpoint_best.pt
selected_cols=1,4,2
